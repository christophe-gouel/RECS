...
\graphicspath{{Figures/}CMRoman/}

% Bibliography
\usepackage[comma]{natbib}
\bibliographystyle{apalike4}%
...
\title{}
% \title{\MyTitle%
%   \thanks{Support from the AgFoodTrade project funded under the 7th Framework
%     Programme for Research and Development, DG-Research, European Commission, is
%     acknowledged.}}%
\date{\today}%
