...
% state space has been properly defined (i.e., neither too small nor too large),
% this first guess is good enough to allow the stochastic solver to converge.
%
...
% guess can be extremely good. For example, in <gro1.html the stochastic
...
% solution. However, in <gro2.html the stochastic growth model with
...
% call a function, but only to define a n-by-m matrix |x| that provides the
