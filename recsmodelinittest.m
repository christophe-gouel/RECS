...
dolorecs = fullfile(recsdirectory,'dynare-python','dolo','src','bin','dolo-recs.py');
dolo     = fullfile(recsdirectory,'dynare-python','dolo','src');

% status = system(['python ' dolorecs ' ' which(inputfile) ' ' fullfile(inputfiledirectory,outputfile)]);
